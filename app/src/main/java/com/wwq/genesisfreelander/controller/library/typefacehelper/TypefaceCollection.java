package com.wwq.genesisfreelander.controller.library.typefacehelper;
...
public class TypefaceCollection {
	...
	public static class Builder {
		...
		/**
		 * This typeface is set in fist {@link #set(int, Typeface)}
		 ...
		 * @throws IllegalStateException when no {@link Typeface}
		 *         has been set via {@link #set(int, Typeface)}
	 ...
	 * <ul>
	 *     <li>{@link Typeface#DEFAULT}</li>
	 *     <li>{@link Typeface#DEFAULT_BOLD}</li>
	 * </ul>
