package com.wwq.genesisfreelander.view.widget.custom;
...
import com.wwq.genesisfreelander.controller.utils.ColorUtils;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIsBackUseDrawable) {
            ...
            if (mFadeBack) {
                ...
                colorAlpha = colorAlpha * alpha / 255;
                mPaint.setARGB(colorAlpha, Color.blue(mNextBackColor), Color.green(mNextBackColor), Color.blue(mNextBackColor));
                canvas.drawRoundRect(mBackRectF, mBackRadius, mBackRadius, mPaint);
        ...
        if (mDrawDebugRect) {
            ...
            mRectPaint.setColor(Color.parseColor("#14B9C7"));
